...
<qgis hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyDrawingHints="1" symbologyReferenceScale="-1" version="3.34.4-Prizren" simplifyMaxScale="1" maxScale="0" styleCategories="AllStyleCategories" simplifyLocal="1" minScale="100000000" readOnly="0" simplifyDrawingTol="1" labelsEnabled="0">
      ...
      <symbol is_animated="0" name="0" force_rhr="0" alpha="1" type="fill" frame_rate="10" clip_to_extent="1">
        ...
        <layer class="SimpleFill" pass="0" locked="0" id="{d135d722-89a4-4084-85e7-b50c481ac4c1}" enabled="1">
          <Option type="Map">
            ...
            <Option name="outline_color" type="QString" value="255,255,255,102"/>
            <Option name="outline_style" type="QString" value="solid"/>
      ...
      <symbol is_animated="0" name="1" force_rhr="0" alpha="1" type="fill" frame_rate="10" clip_to_extent="1">
        ...
        <layer class="SimpleFill" pass="0" locked="0" id="{2ec25cbc-f7ba-4dab-96bc-4330740654f0}" enabled="1">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="Pixel"/>
            <Option name="outline_color" type="QString" value="255,255,255,127"/>
            <Option name="outline_style" type="QString" value="solid"/>
        ...
        <layer class="PointPatternFill" pass="0" locked="0" id="{c9d29dbf-5542-4c14-bd48-f7f3b110b73f}" enabled="1">
          <Option type="Map">
            ...
            <Option name="distance_x" type="QString" value="23"/>
            <Option name="distance_x_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="distance_x_unit" type="QString" value="Pixel"/>
            <Option name="distance_y" type="QString" value="23"/>
            <Option name="distance_y_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="distance_y_unit" type="QString" value="Pixel"/>
            ...
            <Option name="seed" type="QString" value="0"/>
          </Option>
          <data_defined_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
          ...
          <symbol is_animated="0" name="@1@1" force_rhr="0" alpha="1" type="marker" frame_rate="10" clip_to_extent="1">
            ...
            <layer class="SimpleMarker" pass="0" locked="0" id="{84c993e5-52e1-4eeb-b75f-6262406a7c1d}" enabled="1">
              <Option type="Map">
                <Option name="angle" type="QString" value="0"/>
                <Option name="cap_style" type="QString" value="square"/>
                <Option name="color" type="QString" value="149,165,230,255"/>
                <Option name="horizontal_anchor_point" type="QString" value="1"/>
                <Option name="joinstyle" type="QString" value="bevel"/>
      ...
      <symbol is_animated="0" name="3" force_rhr="0" alpha="1" type="fill" frame_rate="10" clip_to_extent="1">
        ...
        <layer class="LinePatternFill" pass="0" locked="0" id="{dfa23100-daa7-4bae-8ce7-e21e3082c2eb}" enabled="1">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="165,183,255,255"/>
            <Option name="coordinate_reference" type="QString" value="feature"/>
            <Option name="distance" type="QString" value="7"/>
            <Option name="distance_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="distance_unit" type="QString" value="Pixel"/>
          ...
          <symbol is_animated="0" name="@3@1" force_rhr="0" alpha="1" type="line" frame_rate="10" clip_to_extent="1">
            ...
            <layer class="SimpleLine" pass="0" locked="0" id="{ccb62635-d1ce-4948-b7a0-9bd78dc5be40}" enabled="1">
              <Option type="Map">
                ...
                <Option name="draw_inside_polygon" type="QString" value="0"/>
                <Option name="joinstyle" type="QString" value="bevel"/>
                <Option name="line_color" type="QString" value="165,183,255,255"/>
                <Option name="line_style" type="QString" value="solid"/>
                <Option name="line_width" type="QString" value="4"/>
                <Option name="line_width_unit" type="QString" value="Pixel"/>
                <Option name="offset" type="QString" value="0"/>
      ...
      <symbol is_animated="0" name="4" force_rhr="0" alpha="1" type="fill" frame_rate="10" clip_to_extent="1">
        ...
        <layer class="SimpleFill" pass="0" locked="0" id="{1419473e-165e-4f79-90fb-7ec175cc8176}" enabled="1">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="Pixel"/>
            <Option name="outline_color" type="QString" value="114,133,132,63"/>
            <Option name="outline_style" type="QString" value="solid"/>
            <Option name="outline_width" type="QString" value="0.5"/>
            <Option name="outline_width_unit" type="QString" value="Pixel"/>
            <Option name="style" type="QString" value="solid"/>
      ...
      <symbol is_animated="0" name="5" force_rhr="0" alpha="1" type="fill" frame_rate="10" clip_to_extent="1">
        ...
        <layer class="SimpleFill" pass="0" locked="0" id="{255cedc4-24e8-445c-95fc-cb9ef81aac67}" enabled="1">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="Pixel"/>
            <Option name="outline_color" type="QString" value="255,255,255,178"/>
            <Option name="outline_style" type="QString" value="solid"/>
            <Option name="outline_width" type="QString" value="0.5"/>
            <Option name="outline_width_unit" type="QString" value="Pixel"/>
            <Option name="style" type="QString" value="solid"/>
      ...
      <symbol is_animated="0" name="7" force_rhr="0" alpha="1" type="fill" frame_rate="10" clip_to_extent="1">
        ...
        <layer class="SimpleFill" pass="0" locked="0" id="{62eab7a2-6db8-4235-baec-b0975d42a305}" enabled="1">
          <Option type="Map">
            ...
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="Pixel"/>
            <Option name="outline_color" type="QString" value="153,153,153,127"/>
            <Option name="outline_style" type="QString" value="solid"/>
            <Option name="outline_width" type="QString" value="0.5"/>
            <Option name="outline_width_unit" type="QString" value="Pixel"/>
            <Option name="style" type="QString" value="solid"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option name="dualview/previewExpressions" type="List">
        <Option type="QString" value="&quot;laatste_wijziging&quot;"/>
      </Option>
  ...
  <fieldConfiguration>
    ...
    <field name="laatste_wijziging" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="wijziging" configurationFlags="NoFlag">
    ...
    <field name="bgt_identificatie" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="bgt_fysiek_voorkomen" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="type_verharding" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="graad_verharding" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="hellingstype" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="hellingspercentage" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="type_private_voorziening" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="berging_private_voorziening" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="build_year" configurationFlags="NoFlag">
    ...
    <field name="gemengd_riool" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="hemelwaterriool" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="vgs_hemelwaterriool" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="vuilwaterriool" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="infiltratievoorziening" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="open_water" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="maaiveld" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="leidingcode_gemengd" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="leidingcode_hwa" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="leidingcode_dwa" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
    ...
    <field name="leidingcode_infiltratie" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="Handmatige wijziging" field="wijziging" index="2"/>
    <alias name="BGT Identificatie" field="bgt_identificatie" index="3"/>
    <alias name="Type oppervlak (BGT)" field="surface_type" index="4"/>
    <alias name="Fysiek voorkomen (BGT)" field="bgt_fysiek_voorkomen" index="5"/>
    <alias name="Type verharding" field="type_verharding" index="6"/>
    <alias name="Verhardingsgraad (%)" field="graad_verharding" index="7"/>
    <alias name="Hellingstype" field="hellingstype" index="8"/>
    <alias name="Helling (%)" field="hellingspercentage" index="9"/>
    <alias name="Type private voorziening" field="type_private_voorziening" index="10"/>
    <alias name="Berging private voorziening" field="berging_private_voorziening" index="11"/>
    <alias name="Bouwjaar (BAG)" field="build_year" index="12"/>
    <alias name="Gemengd riool (%)" field="gemengd_riool" index="13"/>
    <alias name="Hemelwaterriool (%)" field="hemelwaterriool" index="14"/>
    <alias name="VGS Hemelwaterriool (%)" field="vgs_hemelwaterriool" index="15"/>
    <alias name="Vuilwaterriool (%)" field="vuilwaterriool" index="16"/>
    <alias name="Infiltratievoorziening (%)" field="infiltratievoorziening" index="17"/>
    <alias name="Open water (%)" field="open_water" index="18"/>
    <alias name="Maaiveld (%)" field="maaiveld" index="19"/>
    <alias name="Code Gemengd riool" field="leidingcode_gemengd" index="20"/>
    <alias name="Code Hemelwaterriool" field="leidingcode_hwa" index="21"/>
    <alias name="Code Vuilwaterriool" field="leidingcode_dwa" index="22"/>
    <alias name="Code Infiltratievoorziening" field="leidingcode_infiltratie" index="23"/>
  </aliases>
  <splitPolicies>
    <policy field="id" policy="Duplicate"/>
    <policy field="laatste_wijziging" policy="Duplicate"/>
    <policy field="wijziging" policy="Duplicate"/>
    <policy field="bgt_identificatie" policy="Duplicate"/>
    <policy field="surface_type" policy="Duplicate"/>
    <policy field="bgt_fysiek_voorkomen" policy="Duplicate"/>
    <policy field="type_verharding" policy="Duplicate"/>
    <policy field="graad_verharding" policy="Duplicate"/>
    <policy field="hellingstype" policy="Duplicate"/>
    <policy field="hellingspercentage" policy="Duplicate"/>
    <policy field="type_private_voorziening" policy="Duplicate"/>
    <policy field="berging_private_voorziening" policy="Duplicate"/>
    <policy field="build_year" policy="Duplicate"/>
    <policy field="gemengd_riool" policy="Duplicate"/>
    <policy field="hemelwaterriool" policy="Duplicate"/>
    <policy field="vgs_hemelwaterriool" policy="Duplicate"/>
    <policy field="vuilwaterriool" policy="Duplicate"/>
    <policy field="infiltratievoorziening" policy="Duplicate"/>
    <policy field="open_water" policy="Duplicate"/>
    <policy field="maaiveld" policy="Duplicate"/>
    <policy field="leidingcode_gemengd" policy="Duplicate"/>
    <policy field="leidingcode_hwa" policy="Duplicate"/>
    <policy field="leidingcode_dwa" policy="Duplicate"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="leidingcode_gemengd" type="field" hidden="0" width="-1"/>
      <column name="leidingcode_hwa" type="field" hidden="0" width="-1"/>
      <column name="leidingcode_dwa" type="field" hidden="0" width="-1"/>
      <column name="leidingcode_infiltratie" type="field" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer horizontalStretch="0" groupBox="1" name="Voert af naar..." visibilityExpressionEnabled="0" collapsed="0" verticalStretch="0" type="GroupBox" columnCount="1" collapsedExpressionEnabled="0" visibilityExpression="" showLabel="1" collapsedExpression="">
      ...
      <attributeEditorField horizontalStretch="0" name="leidingcode_gemengd" verticalStretch="0" showLabel="1" index="20">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont bold="0" italic="0" strikethrough="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="leidingcode_hwa" verticalStretch="0" showLabel="1" index="21">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont bold="0" italic="0" strikethrough="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="leidingcode_dwa" verticalStretch="0" showLabel="1" index="22">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont bold="0" italic="0" strikethrough="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
      <attributeEditorField horizontalStretch="0" name="leidingcode_infiltratie" verticalStretch="0" showLabel="1" index="23">
        <labelStyle labelColor="0,0,0,255" overrideLabelFont="0" overrideLabelColor="0">
          <labelFont bold="0" italic="0" strikethrough="0" description="MS Shell Dlg 2,8,-1,5,50,0,0,0,0,0" underline="0" style=""/>
        </labelStyle>
      </attributeEditorField>
  ...
  <editable>
    <field name="berging_private_voorziening" editable="1"/>
    <field name="bgt_fysiek_voorkomen" editable="1"/>
    <field name="bgt_identificatie" editable="1"/>
    <field name="build_year" editable="1"/>
    ...
    <field name="leidingcode_dwa" editable="1"/>
    <field name="leidingcode_gemengd" editable="1"/>
    <field name="leidingcode_hwa" editable="1"/>
    <field name="leidingcode_infiltratie" editable="1"/>
    <field name="maaiveld" editable="1"/>
    <field name="open_water" editable="1"/>
    <field name="surface_type" editable="1"/>
    <field name="type_private_voorziening" editable="1"/>
    <field name="type_verharding" editable="1"/>
    <field name="vgs_hemelwaterriool" editable="1"/>
    <field name="vuilwaterriool" editable="1"/>
    <field name="wijziging" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="berging_private_voorziening" labelOnTop="0"/>
    <field name="bgt_fysiek_voorkomen" labelOnTop="0"/>
    <field name="bgt_identificatie" labelOnTop="0"/>
    <field name="build_year" labelOnTop="0"/>
    ...
    <field name="leidingcode_dwa" labelOnTop="0"/>
    <field name="leidingcode_gemengd" labelOnTop="0"/>
    <field name="leidingcode_hwa" labelOnTop="0"/>
    <field name="leidingcode_infiltratie" labelOnTop="0"/>
    ...
    <field name="wijziging" labelOnTop="0"/>
  </labelOnTop>
  <reuseLastValue>
    <field name="berging_private_voorziening" reuseLastValue="0"/>
    <field name="bgt_fysiek_voorkomen" reuseLastValue="0"/>
    <field name="bgt_identificatie" reuseLastValue="0"/>
    <field name="build_year" reuseLastValue="0"/>
    ...
    <field name="leidingcode_dwa" reuseLastValue="0"/>
    <field name="leidingcode_gemengd" reuseLastValue="0"/>
    <field name="leidingcode_hwa" reuseLastValue="0"/>
    <field name="leidingcode_infiltratie" reuseLastValue="0"/>
    <field name="maaiveld" reuseLastValue="0"/>
    <field name="open_water" reuseLastValue="0"/>
    <field name="surface_type" reuseLastValue="0"/>
    ...
    <field name="wijziging" reuseLastValue="0"/>
  </reuseLastValue>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>"laatste_wijziging"</previewExpression>
