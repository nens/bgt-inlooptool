...
from core.constants import (
    ...
    CHECKS_LARGE_AREA,
    CHECKS_TABLE_FIELD_CODE,
    CHECKS_TABLE_FIELD_COLUMN,
    CHECKS_TABLE_FIELD_DESCRIPTION,
    CHECKS_TABLE_FIELD_ID,
    CHECKS_TABLE_FIELD_LEVEL,
    CHECKS_TABLE_FIELD_TABLE,
    CHECKS_TABLE_FIELD_VALUE,
    CHECKS_TABLE_NAME,
    CONNECTABLE_SURFACE_TYPES,
    DISTANCE_TYPES,
    GWSW_PIPE_TYPE_AANSLUITLEIDING,
    GWSW_PIPE_TYPE_BERGINGSLEIDING,
    GWSW_PIPE_TYPE_DITRIOOL,
    GWSW_PIPE_TYPE_DRAIN,
    GWSW_PIPE_TYPE_DRUKLEIDING,
    GWSW_PIPE_TYPE_DUIKER,
    GWSW_PIPE_TYPE_DWAPERCEELAANSLUITLEIDING,
    GWSW_PIPE_TYPE_FIELD,
    GWSW_PIPE_TYPE_GEMENGDEPERCEELAANSLUITLEIDING,
    GWSW_PIPE_TYPE_GEMENGDRIOOL,
    GWSW_PIPE_TYPE_HEMELWATERRIOOL,
    GWSW_PIPE_TYPE_HWAPERCEELAANSLUITLEIDING,
    GWSW_PIPE_TYPE_INFILTRATIERIOOL,
    GWSW_PIPE_TYPE_LOZELEIDING,
    GWSW_PIPE_TYPE_LUCHTPERSLEIDING,
    GWSW_PIPE_TYPE_MANTELBUIS,
    GWSW_PIPE_TYPE_OVERSTORTLEIDING,
    GWSW_PIPE_TYPE_PERCEELAANSLUITLEIDING,
    GWSW_PIPE_TYPE_PERSLEIDING,
    GWSW_PIPE_TYPE_TRANSPORTRIOOLLEIDING,
    GWSW_PIPE_TYPE_VUILWATERRIOOL,
    ...
    RESULT_TABLE_FIELD_CODE_DWA,
    RESULT_TABLE_FIELD_CODE_GEMENGD,
    RESULT_TABLE_FIELD_CODE_HWA,
    RESULT_TABLE_FIELD_CODE_INFILTRATIE,
    RESULT_TABLE_FIELD_GRAAD_VERHARDING,
    RESULT_TABLE_FIELD_HELLINGSPERCENTAGE,
    RESULT_TABLE_FIELD_HELLINGSTYPE,
    RESULT_TABLE_FIELD_ID,
    RESULT_TABLE_FIELD_LAATSTE_WIJZIGING,
    RESULT_TABLE_FIELD_TYPE_PRIVATE_VOORZIENING,
    RESULT_TABLE_FIELD_TYPE_VERHARDING,
    RESULT_TABLE_FIELD_WIJZIGING,
    RESULT_TABLE_NAME,
    RESULT_TABLE_NAME_PREV,
    SETTINGS_TABLE_FIELD_AFKOPPELEN_HELLEND,
    SETTINGS_TABLE_FIELD_AFSTAND_AFKOPPELD,
    SETTINGS_TABLE_FIELD_AFSTAND_AFWATERINGSVOORZIENING,
    SETTINGS_TABLE_FIELD_AFSTAND_DRIEVOUDIG,
    SETTINGS_TABLE_FIELD_AFSTAND_PAND_OPP_WATER,
    SETTINGS_TABLE_FIELD_AFSTAND_VERHARD_KOLK,
    SETTINGS_TABLE_FIELD_AFSTAND_VERHARD_OPP_WATER,
    SETTINGS_TABLE_FIELD_BOUWJAAR_GESCHEIDEN_BINNENHUIS,
    SETTINGS_TABLE_FIELD_DOWNLOAD_BAG,
    SETTINGS_TABLE_FIELD_DOWNLOAD_BGT,
    SETTINGS_TABLE_FIELD_DOWNLOAD_GWSW,
    SETTINGS_TABLE_FIELD_ID,
    SETTINGS_TABLE_FIELD_LEIDINGCODES_KOPPELEN,
    SETTINGS_TABLE_FIELD_PAD_BAG,
    SETTINGS_TABLE_FIELD_PAD_BGT,
    SETTINGS_TABLE_FIELD_PAD_GWSW,
    SETTINGS_TABLE_FIELD_PAD_KOLKEN,
    SETTINGS_TABLE_FIELD_TIJD_EIND,
    SETTINGS_TABLE_FIELD_TIJD_START,
    SETTINGS_TABLE_FIELD_VERHARDINGSGRAAD_ERF,
    SETTINGS_TABLE_FIELD_VERHARDINGSGRAAD_HALF_VERHARD,
    SETTINGS_TABLE_NAME,
    SETTINGS_TABLE_NAME_PREV,
    SOURCE_PIPES_TABLE_NAME,
    STATISTICS_TABLE_FIELD_ID,
    STATISTICS_TABLE_FIELD_OPP_DAK,
    STATISTICS_TABLE_FIELD_OPP_DWA,
    STATISTICS_TABLE_FIELD_OPP_DWA_DAK,
    STATISTICS_TABLE_FIELD_OPP_DWA_GESL_VERH,
    STATISTICS_TABLE_FIELD_OPP_DWA_ONVERHARD,
    STATISTICS_TABLE_FIELD_OPP_DWA_OPEN_VERH,
    STATISTICS_TABLE_FIELD_OPP_GEMENGD,
    STATISTICS_TABLE_FIELD_OPP_GEMENGD_DAK,
    STATISTICS_TABLE_FIELD_OPP_GEMENGD_GESL_VERH,
    STATISTICS_TABLE_FIELD_OPP_GEMENGD_ONVERHARD,
    STATISTICS_TABLE_FIELD_OPP_GEMENGD_OPEN_VERH,
    STATISTICS_TABLE_FIELD_OPP_GESL_VERH,
    STATISTICS_TABLE_FIELD_OPP_GROEN_DAK,
    STATISTICS_TABLE_FIELD_OPP_HWA,
    STATISTICS_TABLE_FIELD_OPP_HWA_DAK,
    STATISTICS_TABLE_FIELD_OPP_HWA_GESL_VERH,
    STATISTICS_TABLE_FIELD_OPP_HWA_ONVERHARD,
    ...
    STATISTICS_TABLE_FIELD_OPP_INFILTRATIEVOORZIENING_ONVERHARD,
    STATISTICS_TABLE_FIELD_OPP_INFILTRATIEVOORZIENING_OPEN_VERH,
    STATISTICS_TABLE_FIELD_OPP_MAAIVELD,
    STATISTICS_TABLE_FIELD_OPP_MAAIVELD_DAK,
    STATISTICS_TABLE_FIELD_OPP_MAAIVELD_GESL_VERH,
    STATISTICS_TABLE_FIELD_OPP_MAAIVELD_ONVERHARD,
    STATISTICS_TABLE_FIELD_OPP_MAAIVELD_OPEN_VERH,
    STATISTICS_TABLE_FIELD_OPP_ONVERHARD,
    STATISTICS_TABLE_FIELD_OPP_OPEN_VERH,
    STATISTICS_TABLE_FIELD_OPP_OPEN_WATER,
    STATISTICS_TABLE_FIELD_OPP_OPEN_WATER_DAK,
    STATISTICS_TABLE_FIELD_OPP_OPEN_WATER_GESL_VERH,
    STATISTICS_TABLE_FIELD_OPP_OPEN_WATER_ONVERHARD,
    STATISTICS_TABLE_FIELD_OPP_OPEN_WATER_OPEN_VERH,
    STATISTICS_TABLE_FIELD_OPP_TOTAAL,
    STATISTICS_TABLE_FIELD_OPP_TOTAAL_DAK,
    STATISTICS_TABLE_FIELD_OPP_TOTAAL_GESL_VERH,
    STATISTICS_TABLE_FIELD_OPP_TOTAAL_ONVERHARD,
    STATISTICS_TABLE_FIELD_OPP_TOTAAL_OPEN_VERH,
    STATISTICS_TABLE_FIELD_OPP_VGS,
    STATISTICS_TABLE_FIELD_OPP_VGS_DAK,
    STATISTICS_TABLE_FIELD_OPP_VGS_GESL_VERH,
    STATISTICS_TABLE_FIELD_OPP_VGS_ONVERHARD,
    STATISTICS_TABLE_FIELD_OPP_VGS_OPEN_VERH,
    STATISTICS_TABLE_FIELD_OPP_WATER,
    STATISTICS_TABLE_FIELD_OPP_WATERPAS_VERH,
    STATISTICS_TABLE_FIELD_PERC_DAK,
    STATISTICS_TABLE_FIELD_PERC_DWA,
    STATISTICS_TABLE_FIELD_PERC_DWA_DAK,
    STATISTICS_TABLE_FIELD_PERC_DWA_GESL_VERH,
    STATISTICS_TABLE_FIELD_PERC_DWA_ONVERHARD,
    STATISTICS_TABLE_FIELD_PERC_DWA_OPEN_VERH,
    STATISTICS_TABLE_FIELD_PERC_GEMENGD,
    STATISTICS_TABLE_FIELD_PERC_GEMENGD_DAK,
    STATISTICS_TABLE_FIELD_PERC_GEMENGD_GESL_VERH,
    STATISTICS_TABLE_FIELD_PERC_GEMENGD_ONVERHARD,
    STATISTICS_TABLE_FIELD_PERC_GEMENGD_OPEN_VERH,
    STATISTICS_TABLE_FIELD_PERC_GESL_VERH,
    STATISTICS_TABLE_FIELD_PERC_GROEN_DAK,
    STATISTICS_TABLE_FIELD_PERC_HWA,
    STATISTICS_TABLE_FIELD_PERC_HWA_DAK,
    STATISTICS_TABLE_FIELD_PERC_HWA_GESL_VERH,
    STATISTICS_TABLE_FIELD_PERC_HWA_ONVERHARD,
    STATISTICS_TABLE_FIELD_PERC_HWA_OPEN_VERH,
    STATISTICS_TABLE_FIELD_PERC_INFILTRATIEVOORZIENING,
    STATISTICS_TABLE_FIELD_PERC_INFILTRATIEVOORZIENING_DAK,
    STATISTICS_TABLE_FIELD_PERC_INFILTRATIEVOORZIENING_GESL_VERH,
    STATISTICS_TABLE_FIELD_PERC_INFILTRATIEVOORZIENING_ONVERHARD,
    STATISTICS_TABLE_FIELD_PERC_INFILTRATIEVOORZIENING_OPEN_VERH,
    STATISTICS_TABLE_FIELD_PERC_MAAIVELD,
    STATISTICS_TABLE_FIELD_PERC_MAAIVELD_DAK,
    ...
    STATISTICS_TABLE_FIELD_PERC_OPEN_VERH,
    STATISTICS_TABLE_FIELD_PERC_OPEN_WATER,
    STATISTICS_TABLE_FIELD_PERC_OPEN_WATER_DAK,
    STATISTICS_TABLE_FIELD_PERC_OPEN_WATER_GESL_VERH,
    STATISTICS_TABLE_FIELD_PERC_OPEN_WATER_ONVERHARD,
    STATISTICS_TABLE_FIELD_PERC_OPEN_WATER_OPEN_VERH,
    STATISTICS_TABLE_FIELD_PERC_VGS,
    STATISTICS_TABLE_FIELD_PERC_VGS_DAK,
    STATISTICS_TABLE_FIELD_PERC_VGS_GESL_VERH,
    STATISTICS_TABLE_FIELD_PERC_VGS_ONVERHARD,
    STATISTICS_TABLE_FIELD_PERC_VGS_OPEN_VERH,
    STATISTICS_TABLE_FIELD_PERC_WATER,
...
class InloopTool:
    ...
    def set_settings_start(self, bgt_file, pipe_file, building_file, kolken_file):
        ...
        prev_settings = self._database.mem_database.GetLayerByName(
            SETTINGS_TABLE_NAME_PREV
        )

        if prev_settings is not None:
            self._database.copy_features_with_matching_fields(
                prev_settings, settings_table, "run_id"
            )
        ...
        feature.SetField(SETTINGS_TABLE_FIELD_PAD_BGT, bgt_file)
        feature.SetField(SETTINGS_TABLE_FIELD_PAD_GWSW, pipe_file)
        feature.SetField(SETTINGS_TABLE_FIELD_PAD_BAG, building_file)
        feature.SetField(SETTINGS_TABLE_FIELD_PAD_KOLKEN, kolken_file)
        feature.SetField(
            SETTINGS_TABLE_FIELD_AFSTAND_AFWATERINGSVOORZIENING,
        ...
        feature.SetField(
            SETTINGS_TABLE_FIELD_AFSTAND_VERHARD_OPP_WATER,
            self.parameters.max_afstand_vlak_oppwater,
        )
        feature.SetField(
            SETTINGS_TABLE_FIELD_AFSTAND_PAND_OPP_WATER,
            self.parameters.max_afstand_pand_oppwater,
        )
        feature.SetField(
            SETTINGS_TABLE_FIELD_AFSTAND_VERHARD_KOLK,
            self.parameters.max_afstand_vlak_kolk,
        )
        feature.SetField(
            SETTINGS_TABLE_FIELD_AFSTAND_AFKOPPELD,
            self.parameters.max_afstand_afgekoppeld,
        )
        feature.SetField(
            SETTINGS_TABLE_FIELD_AFSTAND_DRIEVOUDIG,
            self.parameters.max_afstand_drievoudig,
        )
        feature.SetField(
            SETTINGS_TABLE_FIELD_VERHARDINGSGRAAD_ERF,
            self.parameters.verhardingsgraad_erf,
        )
        feature.SetField(
            SETTINGS_TABLE_FIELD_VERHARDINGSGRAAD_HALF_VERHARD,
            self.parameters.verhardingsgraad_half_verhard,
        )
        feature.SetField(
            SETTINGS_TABLE_FIELD_AFKOPPELEN_HELLEND,
            self.parameters.afkoppelen_hellende_daken,
        )
        feature.SetField(
            SETTINGS_TABLE_FIELD_BOUWJAAR_GESCHEIDEN_BINNENHUIS,
            self.parameters.bouwjaar_gescheiden_binnenhuisriolering,
        )
        feature.SetField(
            SETTINGS_TABLE_FIELD_LEIDINGCODES_KOPPELEN,
            self.parameters.leidingcodes_koppelen,
        )
    ...
    def import_surfaces(self, file_path, extent_wkt):
        ...
        self.relative_hoogteligging_surfaces = (
            self._database.identify_overlapping_surfaces()
        )
    ...
    def calculate_distances(self, parameters):
        ...
        for surface in self._database.bgt_surfaces:
                    ...
                    if internal_pipe_type != INTERNAL_PIPE_TYPE_IGNORE:
                        if (
                            ...
                            distances[internal_pipe_type] = {
                                "distance": pipe_geom.Distance(surface_geom),
                                "leidingcode": pipe["naam"],
                            }
                        else:
                            if distances[internal_pipe_type][
                                "distance"
            ...
            if surface.surface_type != SURFACE_TYPE_WATERDEEL:
                ...
                # add to dict
                distances[OPEN_WATER] = {
                    "distance": min_water_distance,
                    "leidingcode": None,
                }
            # Distance to kolk
            if self.parameters.gebruik_kolken:
            ...
            for distance_type in DISTANCE_TYPES:
                ...
                if distance_type in distances:
                    ...
                    surface["code_" + distance_type] = distances[distance_type][
                        "leidingcode"
                    ]
    ...
    def calculate_runoff_targets(self):
        ...
        for surface in bgt_surfaces:
            ...
            feature.SetField("surface_type", surface.surface_type)
            feature.SetField("bgt_fysiek_voorkomen", surface.bgt_fysiek_voorkomen)
            feature.SetField("build_year", surface.build_year)
            feature.SetField(RESULT_TABLE_FIELD_WIJZIGING, 0)
            ...
            if self.parameters.leidingcodes_koppelen:
                if feature.GetField(TARGET_TYPE_GEMENGD_RIOOL) > 0:
                    feature.SetField(
                        RESULT_TABLE_FIELD_CODE_GEMENGD,
                        surface["code_" + INTERNAL_PIPE_TYPE_GEMENGD_RIOOL],
                    )
                if (
                    feature.GetField(TARGET_TYPE_HEMELWATERRIOOL) > 0
                    or feature.GetField(TARGET_TYPE_VGS_HEMELWATERRIOOL) > 0
                ):
                    if feature.GetField(TARGET_TYPE_HEMELWATERRIOOL) > feature.GetField(
                        TARGET_TYPE_VGS_HEMELWATERRIOOL
                    ):
                        feature.SetField(
                            RESULT_TABLE_FIELD_CODE_HWA,
                            surface["code_" + INTERNAL_PIPE_TYPE_HEMELWATERRIOOL],
                        )
                    else:
                        feature.SetField(
                            RESULT_TABLE_FIELD_CODE_HWA,
                            surface["code_" + INTERNAL_PIPE_TYPE_VGS_HEMELWATERRIOOL],
                        )
                if feature.GetField(TARGET_TYPE_VUILWATERRIOOL) > 0:
                    feature.SetField(
                        RESULT_TABLE_FIELD_CODE_DWA,
                        surface["code_" + INTERNAL_PIPE_TYPE_VUILWATERRIOOL],
                    )
                if feature.GetField(TARGET_TYPE_INFILTRATIEVOORZIENING) > 0:
                    feature.SetField(
                        RESULT_TABLE_FIELD_CODE_INFILTRATIE,
                        surface["code_" + INTERNAL_PIPE_TYPE_INFILTRATIEVOORZIENING],
                    )
    ...
    def overwrite_by_manual_edits(self):
        result_table = self._database.result_table
        manual_results_prev = self._database.mem_database.GetLayerByName(
            RESULT_TABLE_NAME_PREV
        )
        bgt_surfaces = self._database.bgt_surfaces
            ...
            if self.parameters.leidingcodes_koppelen:
                ...
                if prev_feat.GetField(TARGET_TYPE_GEMENGD_RIOOL) > 0:
                    if INTERNAL_PIPE_TYPE_GEMENGD_RIOOL in distances:
                        prev_feat.SetField(
                            RESULT_TABLE_FIELD_CODE_GEMENGD,
                            distances[INTERNAL_PIPE_TYPE_GEMENGD_RIOOL]["leidingcode"],
                        )
                    else:
                        print(
                            f"No mixed sewerage pipe found for prev_feat {prev_feat.GetFID()}"
                        )

                elif (
                    prev_feat.GetField(TARGET_TYPE_HEMELWATERRIOOL) > 0
                    or prev_feat.GetField(TARGET_TYPE_VGS_HEMELWATERRIOOL) > 0
                ):
                    if prev_feat.GetField(
                        TARGET_TYPE_HEMELWATERRIOOL
                    ) > prev_feat.GetField(TARGET_TYPE_VGS_HEMELWATERRIOOL):
                        if INTERNAL_PIPE_TYPE_HEMELWATERRIOOL in distances:
                            prev_feat.SetField(
                                RESULT_TABLE_FIELD_CODE_HWA,
                                distances[INTERNAL_PIPE_TYPE_HEMELWATERRIOOL][
                                    "leidingcode"
                                ],
                            )
                        else:
                            print(
                                f"No rainwater pipe found for prev_feat {prev_feat.GetFID()}"
                            )
                    elif INTERNAL_PIPE_TYPE_VGS_HEMELWATERRIOOL in distances:
                        prev_feat.SetField(
                            RESULT_TABLE_FIELD_CODE_HWA,
                            distances[INTERNAL_PIPE_TYPE_VGS_HEMELWATERRIOOL][
                                "leidingcode"
                            ],
                        )
                    else:
                        print(
                            f"No VGS rainwater pipe found for prev_feat {prev_feat.GetFID()}"
                        )
                    ...
                    if INTERNAL_PIPE_TYPE_VUILWATERRIOOL in distances:
                        prev_feat.SetField(
                            RESULT_TABLE_FIELD_CODE_DWA,
                            distances[INTERNAL_PIPE_TYPE_VUILWATERRIOOL]["leidingcode"],
                        )
                    else:
                        print(
                            f"No waste water pipe found for prev_feat {prev_feat.GetFID()}"
                        )
                    ...
                    if INTERNAL_PIPE_TYPE_INFILTRATIEVOORZIENING in distances:
                        prev_feat.SetField(
                            RESULT_TABLE_FIELD_CODE_INFILTRATIE,
                            distances[INTERNAL_PIPE_TYPE_INFILTRATIEVOORZIENING][
                                "leidingcode"
                            ],
                        )
                    else:
                        print(
                            f"No infiltration pipe found for prev_feat {prev_feat.GetFID()}"
                        )
        ...
        if features_to_update:
            ...
            self._database.copy_features_with_matching_fields(
                manual_results_prev, result_table, "id"
            )
        ...
        for prev_feat in manual_results_prev:
            ...
            for surface in bgt_surfaces:
                ...
                if surface_geom.Intersects(prev_feat_geom) and (
                    prev_feat["bgt_identificatie"] != surface["identificatie_lokaalid"]
                ):
    ...
    def intersect_inf_pavement_green_roofs(self):
        result_table = self._database.result_table
        points_layer = self._database.mem_database.GetLayerByName(
            INF_PAVEMENT_TABLE_NAME_PREV
        )
        ...
        if points_layer is None:
            ...
            for point_feature in points_layer:
                point_geom = (
                    point_feature.GetGeometryRef()
                )  # Get the geometry of the current point feature
                ...
                for result_feature in result_table:
                    result_geom = (
                        result_feature.GetGeometryRef()
                    )  # Get the geometry of the current result feature
    ...
    def calculate_statistics(self, stats_path):
        ...
        if not os.path.isfile(stats_abspath):
            raise FileNotFoundError(
                f"Shapefile met gebieden voor statistieken niet gevonden: {stats_abspath}"
            )
                ...
                for middle in field_middle:
                    ...
                    if prefix == "opp":
                        for suffix in field_suffix:
                            field_name = (
                                "STATISTICS_TABLE_FIELD_" + prefix + middle + suffix
                            ).upper()
                            if field_name not in intersection_areas:
                                intersection_areas[field_name] = (
                                    self.calculate_intersection_area(
                                        intersecting_it_features,
                                        new_feature,
                                        middle_key,
                                        suffix[1:],
                                    )
                            ...
                            new_feature.SetField(
                                globals()[field_name], intersection_areas[field_name]
                            )
                    else:
                        for suffix in field_suffix:
                            if middle_key != "totaal":
                                ...
                                field_name_tot = field_name_opp.replace(
                                    middle_key.upper(), "TOTAAL"
                                )
                                if new_feature[globals()[field_name_tot]] > 0:
                                    perc_value = round(
                                        (
                                            100
                                            * new_feature[globals()[field_name_opp]]
                                            / new_feature[globals()[field_name_tot]]
                                        ),
                                        2,
                                    )
                                    new_feature.SetField(
                                        globals()[field_name], perc_value
                                    )

            for prefix in field_prefix:
                for suffix_verharding in field_suffix_verharding:
                    field_name = (
                        "STATISTICS_TABLE_FIELD_" + prefix + suffix_verharding
                    ).upper()
                    if prefix == "opp":
                        if field_name not in intersection_areas:
                            intersection_areas[field_name] = (
                        ...
                        field_name_opp = field_name.replace("PERC", "OPP")
                        field_name_tot = field_name_opp.replace(
                            suffix_verharding[1:].upper(), "TOTAAL"
                        )
                        if new_feature[globals()[field_name_tot]] > 0:
                            perc_value = round(
                                (
    ...
    def calculate_intersection_area(
        self, intersecting_it_features, stats_feature, stat_type, type_verharding
    ):
        it_layer = self._database.result_table
        area_totals = {
            "totaal": 0,
        ...
        for fid in intersecting_it_features:
            ...
            if (
                it_feature[RESULT_TABLE_FIELD_TYPE_VERHARDING] == verhardingstype
                or verhardingstype == ""
            ):
                if (
                    it_geom
                    and stats_geom
                    and it_geom.IsValid()
                    and stats_geom.IsValid()
                    and stats_geom.Intersects(it_geom)
                ):
                    try:
                        ...
                        area_totals["gemengd"] += (
                            intersection_area
                            * it_feature[TARGET_TYPE_GEMENGD_RIOOL]
                            / 100
                        )
                        area_totals["hwa"] += (
                            intersection_area
                            * it_feature[TARGET_TYPE_HEMELWATERRIOOL]
                            / 100
                        )
                        area_totals["vgs"] += (
                            intersection_area
                        ...
                        area_totals["dwa"] += (
                            intersection_area
                            * it_feature[TARGET_TYPE_VUILWATERRIOOL]
                            / 100
                        )
                        area_totals["infiltratievoorziening"] += (
                            intersection_area
                            * it_feature[TARGET_TYPE_INFILTRATIEVOORZIENING]
                            / 100
                        )
                        area_totals["open_water"] += (
                            intersection_area * it_feature[TARGET_TYPE_OPEN_WATER] / 100
                        )
                        area_totals["maaiveld"] += (
                            intersection_area * it_feature[TARGET_TYPE_MAAIVELD] / 100
                        )
    ...
    def generate_warnings(self):
        ...
        for it_feature in it_layer:
            ...
            if area > CHECKS_LARGE_AREA:  # value in m2
                ...
                check_feature.SetField(
                    CHECKS_TABLE_FIELD_DESCRIPTION, warning_large_area
                )
        ...
        for building in self._database.non_matching_buildings:
            ...
            check_feature.SetField(
                CHECKS_TABLE_FIELD_VALUE, building["identificatie_lokaalid"]
            )  # identificatiebagpnd
            check_feature.SetField(
                CHECKS_TABLE_FIELD_DESCRIPTION, warning_bgt_bag_mismatch
            )
            checks_table.CreateFeature(check_feature)
            check_feature = None  # Cleanup after creating the feature
        ...
        for surface in self.inf_pavements_green_roof_surfaces:
            ...
            check_feature.SetField(
                CHECKS_TABLE_FIELD_DESCRIPTION, warning_infiltrating_surfaces
            )
            checks_table.CreateFeature(check_feature)
            check_feature = None  # Cleanup after creating the feature
        ...
        for surface in self.relative_hoogteligging_surfaces:
            ...
            check_feature.SetField(CHECKS_TABLE_FIELD_COLUMN, "BGT Identificatie")
            check_feature.SetField(
                CHECKS_TABLE_FIELD_VALUE, surface["identificatie_lokaalid"]
            )
            check_feature.SetField(
                CHECKS_TABLE_FIELD_DESCRIPTION, warning_relatieve_hoogteligging
            )
            checks_table.CreateFeature(check_feature)
            check_feature = None  # Cleanup after creating the feature
        ...
        for it_feature in self.new_BGT_surfaces:
            ...
            check_feature.SetField(CHECKS_TABLE_FIELD_COLUMN, "BGT identificatie")
            check_feature.SetField(
                CHECKS_TABLE_FIELD_VALUE, it_feature["bgt_identificatie"]
            )
            check_feature.SetField(
                CHECKS_TABLE_FIELD_DESCRIPTION, warning_new_BGT_surfaces
            )
            checks_table.CreateFeature(check_feature)
            check_feature = None  # Cleanup after creating the feature
        ...
        for it_feature in self.outdated_changed_surfaces:
            ...
            check_feature.SetField(
                CHECKS_TABLE_FIELD_DESCRIPTION, warning_outdated_changed_surfaces
            )
            checks_table.CreateFeature(check_feature)
            check_feature = None  # Cleanup after creating the feature
...
class Database:
    ...
    def import_it_results(self, file_path):
        ...
        if not os.path.isfile(prev_gpkg_abspath):
            raise FileNotFoundError(
                "Resultaten GeoPackage vorige run niet gevonden: {}".format(
                    prev_gpkg_abspath
                )
            )
    ...
    def import_inf_pavement_green_roofs(self, file_path):
        ...
        try:
            self.mem_database.CopyLayer(
                it_ds.GetLayerByName("1_Waterpasserende_verharding_en_groene_daken"),
                INF_PAVEMENT_TABLE_NAME_PREV,
            )
        except Exception:
            # TODO more specific exception
        ...
        for surface_type in ALL_USED_SURFACE_TYPES:
            ...
            for feature in layer:
                ...
                if geom is None:
                    ...
                    print(
                        f"Warning: Feature {feature.GetFID()} in layer {surface_type} has no geometry. Skipping."
                    )
                    continue
    ...
    def merge_surfaces(self):
        ...
        for stype in ALL_USED_SURFACE_TYPES:
            ...
            for feature in input_layer:
                ...
                new_feature.SetField(
                    "relatieve_hoogteligging", feature["relatieveHoogteligging"]
                )
    ...
    def identify_overlapping_surfaces(self):
        ...
        for feature in layer:
            ...
            )  # Get the geometry of the current feature (surface)
            hoogteligging1 = feature.GetField(
                "relatieve_hoogteligging"
            )  # Get the "hoogteligging" field
            ...
            for other_feature in layer:
                ...
                geom2 = (
                    other_feature.GetGeometryRef()
                )  # Get the geometry of the other feature
                if geom1.Intersects(
                    geom2
                ):  # Check if the geometries intersect (overlap)
                    hoogteligging2 = other_feature.GetField(
                        "relatieve_hoogteligging"
                    )  # Get the hoogteligging of the other feature
                    ...
                    if hoogteligging1 > hoogteligging2:
                        ...
                        if other_feature not in highest_surfaces:
                            highest_surfaces.append(
                                other_feature
                            )  # Add the other feature if it's not already in the list
    ...
    def copy_features_with_matching_fields(
        self, src_layer, dst_layer, primary_key_field
    ):
    ...
    def _save_to_gpkg(self, file_folder, template_gpkg):
        ...
        if self.mem_database.GetLayerByName(INF_PAVEMENT_TABLE_NAME_PREV) is not None:
            layers.insert(
                ...
                (
                    INF_PAVEMENT_TABLE_NAME_PREV,
                    "1_Waterpasserende_verharding_en_groene_daken",
                ),
            )
    ...
    def copy_and_rename_file(self, original_file_path, new_file_path):
        ...
        try:
            ...
            print(
                f"Permission denied. Unable to copy the template {original_file_path} to {new_file_path}."
            )
        except Exception as e:
    ...
    def _write_to_disk(self, dst_gpkg, db_layer_name, dst_layer_name):
        ...
        if dst_layer is None:
            raise ValueError(
                f"Layer '{dst_layer_name}' not found in destination GeoPackage."
            )
        ...
        if layer_defn.GetFieldCount() != dst_layer_defn.GetFieldCount():
            print(
                f"Warning: Source and destination layers have different field counts: {layer_defn.GetFieldCount()} vs {dst_layer_defn.GetFieldCount()}. Continuing anyway."
            )

        field_mapping = {
            dst_layer_defn.GetFieldDefn(i).GetName(): layer_defn.GetFieldIndex(
                dst_layer_defn.GetFieldDefn(i).GetName()
            )
            ...
            for dst_field_name, src_field_index in field_mapping.items():
                if src_field_index != -1:  # Ensure the field exists in the source layer
                    dst_feature.SetField(
                        dst_field_name, feature.GetField(src_field_index)
                    )
                else:
                    print(
                        f"Warning: Source field '{dst_field_name}' not found in the source layer. Skipping field."
                    )
            # for dst_field_name, src_field_index in field_mapping.items():
