...
class UnitDatabase(unittest.TestCase):
    ...
    def empty_result_table(self):
        ...
        self.assertTrue(
            isinstance(result, ogr.DataSource),
            "empty_result.gpkg is not a valid ogr.Datasource",
        )
    ...
    def test_classify(self):
        ...
        self.assertTrue(db.bgt_surfaces is not None, "db.bgt_surfaces is None")
    ...
    def test_calculate_runoff_targets(self):
        ...
        self.assertTrue(
            isinstance(result, ogr.DataSource),
            "calculated_result.gpkg is not a valid ogr.Datasource",
        )
    ...
    def test_decision_tree(self):
        ...
        self.assertEquals(
            test_result,
            valid_result,
            "FOUT voor: Gemengd plus hwa of infiltratie, nieuw pand, hwa dichtsbij",
        )
        ...
        self.assertEquals(
            test_result,
            valid_result,
            "FOUT voor: Gemengd plus hwa of infiltratie, infiltratie dichtsbij",
        )
        ...
        self.assertEquals(
            test_result,
            valid_result,
            "FOUT voor: Gemengd plus hwa of infiltratie, oud pand, maar niet afkoppelen hellende daken ",
        )
        ...
        valid_result = template_test_result.copy()
        valid_result["gemengd_riool"] = 100
        self.assertEquals(test_result, valid_result, "FOUT voor: Wegdeel")
        ...
        valid_result = template_test_result.copy()
        valid_result["hemelwaterriool"] = 100
        self.assertEquals(test_result, valid_result, "FOUT voor: Wegdeel, alleen rwa")
    ...
    def test_add_buildings(self):
        ...
        for surface in it._database.bgt_surfaces:
            if surface["surface_type"] == "pand":
                self.AssertTrue(
                    surface["build_year"] is not None,
